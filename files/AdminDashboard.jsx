          ...
          <div className="bg-white rounded-bb-lg border border-bb-ink-10 overflow-hidden">
            ...
            <div className="p-5">
              ...
              <div className="flex gap-5 mt-3 text-[0.78rem] text-bb-ink-60">
                ...
                <span className="flex items-center gap-1.5"><span className="inline-block w-3 h-0.5 bg-bb-red rounded" style={{borderTop:'1px dashed'}}/>Critical threshold</span>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-bb-lg border border-bb-ink-10 overflow-hidden">
          ...
          <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-0">
            {ACTIVITY.map(({ icon, cls, text, sub }, i) => (
              <div key={i} className="flex gap-3 py-2.5 border-b border-bb-ink-10 last:border-0 md:[&:nth-last-child(2)]:border-0">
