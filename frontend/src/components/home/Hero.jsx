  ...
  return (
    ...
    ">
      ...
      <div className="hero-content">
        <div className="inline-flex items-center gap-2 bg-bb-red-light text-bb-red px-3.5 py-1 rounded-full text-[0.78rem] font-medium tracking-[0.04em] uppercase mb-5">
        ...
        <h1 className="mb-5 font-serif">
          Connecting <em className="text-bb-red" style={{ fontStyle: 'italic' }}>Life</em>
